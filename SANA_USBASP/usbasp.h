...
#define PROGISP_AVR     0x00
#define PROGISP_MCS51   0x01
#define PROGISP_24CXX   0x04
#define PROGISP_93CXX   0x07
#define USBASP_EXT_RC_OSCILLATOR    1
#define USBASP_EXT_OSCILLATOR       2
...
/* macros for gpio functions */
#define ledRedInit()    DDRB  |= (1 << PB2)
#define ledRedOn()      PORTB &= ~(1 << PB2)
#define ledRedOff()     PORTB |= (1 << PB2)
#define ledGreenInit()  ledRedInit()
#define ledGreenOn()    ledRedOff()
#define ledGreenOff()   ledRedOn()
